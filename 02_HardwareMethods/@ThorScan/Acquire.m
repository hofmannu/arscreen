...
function Acquire(ts, m)
  ...
  % --> responsible for position based trigger
  ...
  for yi = 1:ts.nY
    ...
    % move the y stage to the next position
    m.SlowStage.Wait_Move(); % make sure that slow stage finished previous operation
